                ...
                <form method="post" class="p-5">
                    <h3 class="text-center">User Information</h3>
                        <div class="form-group">
							...
							<input type="text" name="nm" placeholder="Enter your name" class="form-control"/>
						</div>
                        <div class="form-group">
							<label>email</label>
                        ...
                        <div class="form-group">
							...
							<input type="number" name="pn" placeholder="Enter phone number" class="form-control"/>
						</div>
                        <div class="form-group">
							<label>gender</label>
                        ...
                        <div class="form-group">
							...
							<input type="text" name="jp" placeholder="Enter your profile" class="form-control"/>
						</div>
                        <div class="form-group">
